...
-------------------------------------------------------------------------------
 In this exercise, you will implement a simple state machine.

 IF left sensor sees line for the first time -> print "DO NOTHING"
 IF left sensor sees line for the second time -> print "TURN RIGHT"
===============================================================================
*/
...
void loop() {
    ...
    // FIXME: This code will not work of course
